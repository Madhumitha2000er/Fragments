		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment",
									"targetURL": "#nsfragmentdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsfragmentdemo-display": {
								"semanticObject": "nsfragmentdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.fragmentdemo",
									"url": sap.ui.require.toUrl("ns/fragmentdemo")
								}
							}
						}
					}
